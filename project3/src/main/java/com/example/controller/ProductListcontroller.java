...
public class ProductListcontroller {
	...
	public String lpupdate(ProductVO1 vo,String uid, String pmodel){
		System.out.println(vo.getUplike() + "\n" + vo.getPlcount());
		service.lpupdate(vo,uid,pmodel);
		return "redirect:/productList/read?pmodel=" + pmodel + "&uid=" + uid ;
	}
	
	@RequestMapping("/read")
	public String read(Model model, String pmodel,String uid){
		if(uid==null){
			model.addAttribute("vo1", dao.read1(pmodel));
		}
		else{
